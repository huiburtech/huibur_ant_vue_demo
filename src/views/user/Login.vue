<template>
  <div class="main">
    ...
    >
      ...
      <a-form-item>
        <a-checkbox class="table" v-decorator="['rememberMe', { valuePropName: 'checked' }]">{{ $t('user.login.remember-me') }} </a-checkbox>
        <router-link
      ...
      <div class="user-login-other">
        ...
        <a-button size="large" type="primary" class="login-button">
          <router-link :to="{ name: 'register' }">{{ $t('user.login.signup') }}</router-link>
        </a-button>
      </div>
    </a-form>
