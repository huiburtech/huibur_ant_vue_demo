<template>
  <div class="main user-layout-register">
    ...
    <a-form ref="formRegister" :form="form" id="formRegister">
      <a-form-item :label-col="{ span: 5 }" :wrapper-col="{ span: 19 }" label="账号">
        <a-input
          size="large"
          type="text"
          placeholder="请输入账号"
      ...
      <a-popover
        ...
        <a-form-item :label-col="{ span: 5 }" :wrapper-col="{ span: 19 }" label="密码">
          <a-input-password
            size="large"
      ...
      <a-form-item :label-col="{ span: 5 }" :wrapper-col="{ span: 19 }" label="手机号">
      ...
      <a-row :gutter="16">
        <a-col class="gutter-row" :span="16">
          <a-form-item :label-col="{ span: 7 }" :wrapper-col="{ span: 17 }" label="验证码">
